...
{{- default "mairror_api" .Values.mairror_api.nameOverride | trunc 63 | trimSuffix "-" }}
{{- end }}

{{- define "mairror_bot.name" -}}
{{- default "mairror_bot" .Values.mairror_bot.nameOverride | trunc 63 | trimSuffix "-" }}
{{- end }}

{{- define "mairror_processor.name" -}}
{{- default "mairror_processor" .Values.mairror_processor.nameOverride | trunc 63 | trimSuffix "-" }}
{{- end }}
...
{{- else }}
{{- $name := default "mairror_api" .Values.mairror_api.nameOverride }}
...
{{- else }}
{{- $name := default "mairror_bot" .Values.mairror_bot.nameOverride }}
{{- if contains $name .Release.Name }}
{{- .Release.Name | trunc 63 | trimSuffix "-" }}
{{- else }}
{{- printf "%s-%s" .Release.Name $name | trunc 63 | trimSuffix "-" }}
...
{{- else }}
{{- $name := default "mairror_processor" .Values.mairror_processor.nameOverride }}
{{- if contains $name .Release.Name }}
{{- .Release.Name | trunc 63 | trimSuffix "-" }}
{{- else }}
{{- printf "%s-%s" .Release.Name $name | trunc 63 | trimSuffix "-" }}
...
{{- else }}
{{- default "default" .Values.mairror_api.serviceAccount.name }}
{{- end }}
{{- end }}
...
{{- else }}
{{- default "default" .Values.mairror_bot.serviceAccount.name }}
{{- end }}
{{- end }}
...
{{- else }}
{{- default "default" .Values.mairror_processor.serviceAccount.name }}
{{- end }}
{{- end }}
